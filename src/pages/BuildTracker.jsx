...
import { Building2, ClipboardList, Users, Check } from 'lucide-react';
      ...
      <section className="relative bg-gradient-to-br from-gray-50 via-white to-gray-100 pt-16 pb-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg sm:text-xl text-gray-600 max-w-3xl mx-auto px-4 sm:px-0">
            Complete project management and build tracking capabilities for modern teams
          </p>
        </div>
      </section>

      {/* BuildTracker Section */}
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-6">Project Management Made Simple</h2>
              <p className="text-xl text-gray-600 mb-4">
                Everything you need to manage projects
              </p>
              <p className="text-lg text-gray-600 mb-8">
                From planning to execution, BuildTracker provides all the tools your team needs to deliver exceptional results.
              </p>

              <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-8">
                {[
                  { icon: Building2, title: "Multi-Organization", desc: "Role-based permissions" },
                  { icon: ClipboardList, title: "Task Management", desc: "Custom workflows" },
                  { icon: Users, title: "Team Collaboration", desc: "Real-time updates" }
                ].map((feature, index) => {
      ...
      <section className="py-24 bg-black text-white">
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
            Choose BuildTracker for your business needs and get started today.
          </p>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 text-sm text-gray-400 max-w-2xl mx-auto px-4 sm:px-0 mt-8">
            {['Free tier', 'No ads', 'Works offline', 'Cross-platform'].map((item, index) => (
